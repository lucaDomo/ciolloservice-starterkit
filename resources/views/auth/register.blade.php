<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- cellular -->
            <div>
                <x-input-label for="cellular" :value="__('Cellular')" />

                <x-text-input id="cellular" class="block mt-1 w-full" type="text" name="cellular" :value="old('cellular')" required autofocus />
